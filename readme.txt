...
Upon your end-user registration, we will also register him at Custom-Subdomain.PrivacyBunker.cloud
service. PrivacyBunker.cloud service gives your customers full control in terms of the GDPR.
It automates the execution of the following GDPR user rights:
